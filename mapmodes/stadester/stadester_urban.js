...
var eoscala_years = listFiles(`./mapmodes/stadester/data/stadester_urban_rasters/`);
...
clearMap();
new GeoPNG({
    file_path: './mapmodes/stadester/data/stadester_urban_rasters/stadester_urban_' + closest_year + '.png',
    width: 4320,
    height: 2160,
