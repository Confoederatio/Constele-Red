...
var eoscala_years = listFiles(`./mapmodes/stadester/data/stadester_population_rasters/`);
...
clearMap();
new GeoPNG({
    file_path: './mapmodes/stadester/data/stadester_population_rasters/stadester_population_' + closest_year + '.png',
    width: 4320,
    height: 2160,
